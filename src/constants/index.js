 ...
 */
export const THE_BRIDE = 'Annas & Pelangi';
export const GIRL_NAME = 'Pelangi Langit Biru';
export const GIRL_PARENT_NAME = `Putri dari Bapak Agus Jatnika<br /> & Ibu Nining Rustini`;
export const BOY_NAME = 'Annas Pramudita';
export const BOY_PARENT_NAME = `Putra dari Bapak Mahmud Fachruddin (Alm) <br />& Ibu Nining Rosita`;
...
export const API_HOSTNAME =
  'https://script.google.com/macros/s/AKfycbwCbcKeRin5FHwG9TfMsG_WSwm1xc_3M-CzBT86Nr2V3mZ_mtZ4vMgpag/exec';
